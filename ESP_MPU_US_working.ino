...
float magCalibration[3] = {0, 0, 0}, magbias[3] = {10.72,128.08,90.15}, magscale[3] = {0.64,0.74,0.91};  // Factory mag calibration and mag bias
...
float pitch, yaw, roll, nyaw, azim;
...
//  MahonyQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f, my, mx, mz);
    ...
    yaw   *= 180.0f / PI; 
    yaw   -= 1.11; /* Declination at Bangalore, ,India         Model Used:  IGRF12  Help
                                                               //Latitude: 12° 55' 59.4" N
                                                               //Longitude: 77° 37' 40.3" E
                                                              //Magnetic declination: -1° 11'*/   
    if(yaw > -90 && yaw < 90)
    {
      yaw = yaw * 1.7;
      if((yaw > 90 && yaw < 135) || (yaw < -90 && yaw > -135))
      {
        yaw = yaw;
      }
    }
